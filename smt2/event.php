...
<body>
    ...
    <section class="event-section">
        ...
        <a href="?action=tambah" class="btn-event-baru">
        ...
        ?>
            <div class="card-event">
                ...
                <div class="aksi">
                    <a href="?action=edit&id=<?= $data['id'] ?>">edit</a>
                    <a href="?action=hapus&id=<?= $data['id'] ?>" onclick="return confirm('Hapus agenda?')">hapus</a>
                </div>
            </div>
        <?php } ?>
    </section>
    ...
    <div class="overlay">
        <div class="modal">
            <header>
                <a href="event.php"> < Agenda Baru</a>
            </header>
